...
public class JunitDtoHelperMapToDtoTest {
	...
	public void testAll() throws Exception {
		...
		JunitDtoHelperMapToDto helper = new JunitDtoHelperMapToDto();
		...
		ContractDto contractDto2 = ContractDto.class.cast(tubanMap.get("2"));
		testContractDto1_2(contractDto2);

		tubanMap = testNoMap.get("1-2");
		ContractDto contractDto1_2_1 = ContractDto.class.cast(tubanMap.get("1"));
